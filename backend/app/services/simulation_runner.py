...
from .graph_provider import get_graph_memory_manager
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        if enable_graph_memory_update:
            ...
            try:
                get_graph_memory_manager().create_updater(simulation_id, graph_id)
    ...
    def _monitor_simulation(cls, simulation_id: str, locale: str = 'zh'):
        ...
        try:
            ...
            if cls._graph_memory_enabled.get(simulation_id, False):
                try:
                    get_graph_memory_manager().stop_updater(simulation_id)
    ...
    def _read_action_log(
        ...
        if graph_memory_enabled:
            graph_updater = get_graph_memory_manager().get_updater(state.simulation_id)
    ...
    def cleanup_all_simulations(cls):
        ...
        try:
            get_graph_memory_manager().stop_all()
        except Exception as e:
            logger.error(f"停止图谱记忆更新器失败: {e}")
